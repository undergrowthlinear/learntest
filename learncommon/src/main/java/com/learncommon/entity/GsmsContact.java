package com.learncommon.entity;
...
public class GsmsContact {
	...
	public String toString() {
		return "GsmsContact [id=" + id + ", name=" + name + ", phone=" + phone
				+ ", sex=" + sex + ", identifier=" + identifier + ", birthday="
				+ birthday + ", birthMonth=" + birthMonth + ", birthDay="
				+ birthDay + ", vip=" + vip + ", remark=" + remark
				+ ", extension1=" + extension1 + ", extension2=" + extension2
				+ ", extension3=" + extension3 + ", groupId=" + groupId + "]";
	}
